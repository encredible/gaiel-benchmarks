...
> **측정된 모델: 6개.** 아직 채워지지 않은 칸은 측정 전이며, 측정되지 않은 항목에 대해
> 어떤 주장도 하지 않습니다.
...
| 모델 | boolq | copa | hellaswag | sentineg | wic | haerae | **평균** | Δ vs 베이스 | 판정 |
|---|---|---|---|---|---|---|---|---|---|
| _우연 수준_ | _50_ | _50_ | _25_ | _50_ | _50_ | _20_ | _—_ | _—_ | _기준선_ |
| `base-1.5b` | 53.7 | 59.4 | 39.8 | 52.4 ˣ | 48.8 ˣ | 43.7 | **49.6** | — | — |
| `base-7b` | 70.3 | 71.1 | 46.6 | 92.9 | 51.1 ˣ | 59.8 | **65.3** | — | — |
| `base-coder-1.5b` | 50.9 ˣ | 53.1 | 36.6 | 64.2 | 48.8 ˣ | 34.7 | **48.1** | — | — |
| `gaiel-1.5b` | 51.1 ˣ | 57.6 | 34.2 | 52.4 ˣ | 49.0 ˣ | 37.6 | **47.0** | **-2.7** | ⚠️ 회귀 · ˣ3개 우연이하 |
| `gaiel-7b` | 64.8 | 68.4 | 43.6 | 67.0 | 49.0 ˣ | 57.3 | **58.4** | **-6.9** | ⚠️ 회귀 |

`ˣ` = 표준오차 범위 안에서 우연 수준과 구분되지 않음 (그 과제를 실제로 풀지 못한다는 뜻)


### 코딩

| 모델 | humaneval | **평균** | Δ vs 베이스 | 판정 |
|---|---|---|---|---|
| _우연 수준_ | _0_ | _—_ | _—_ | _기준선_ |
| `base-1.5b` | 57.3 | **57.3** | — | — |
| `base-7b` | 86.0 | **86.0** | — | — |
| `base-coder-1.5b` | 66.5 | **66.5** | — | — |
| `base-coder-7b` | 88.4 | **88.4** | — | — |
| `gaiel-1.5b` | 18.3 | **18.3** | **-39.0** | ⚠️ 회귀 |
| `gaiel-7b` | 79.3 | **79.3** | **-6.7** | ⚠️ 회귀 |
